function Logo({ dark = false, showText = true }: { dark?: boolean; showText?: boolean }) {
  return (
    <div className="flex items-center gap-2.5">
      ...
      {showText && (
        <div>
          <p className={`font-black text-[15px] uppercase tracking-tight leading-none ${dark ? "text-white" : "text-black"}`}>
